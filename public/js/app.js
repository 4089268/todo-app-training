 ...
 */
Vue.component('todo-component', __webpack_require__(35));
...
var update = __webpack_require__(39)("43313538", content, false);
    ...
    methods: {
        ...
        removeTodo: function removeTodo(id) {
            ...
            axios.delete('/api/todos/' + id).then(function (response) {
                switch (response.status) {
                    case 200:
                        xthis3.items = xthis3.items.filter(function (item) {
                            return item.id !== id;
                        });
                        alert("Borrado");
                        break;
        ...
        toggleDone: function toggleDone(id) {
            ...
            axios.put('/api/todos/' + id).then(function (response) {
                var todo = xthis4.items.filter(function (item) {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c(
      ...
      _vm._l(_vm.items, function(todo) {
        return _c("todo-item", {
          attrs: { text: todo.text, done: todo.done, id: todo.id },
          on: {
            toggleDone: function($event) {
              _vm.toggleDone($event)
            },
            removeTodo: function($event) {
              _vm.removeTodo($event)
            }
          }
        })
      })
